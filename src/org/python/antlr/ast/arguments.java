...
public class arguments extends PythonTree {
     ...
     * Constructor
     * 
     * XXX: vararg and kwarg are deliberately moved to the end of the method signature to avoid clashes with the
     * {@code (Token, List<expr>, String, String, List<expr>)} version of the constructor.
     * 
     * @param token
     *            token
     * @param args
