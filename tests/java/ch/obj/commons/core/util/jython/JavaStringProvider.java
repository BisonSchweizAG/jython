...
/**
 * A class providing {@code java.lang.String} values for usage in test scripts
 */
public final class JavaStringProvider {

    // Unicode strings
    private static final String SMALL_O_UMLAUT = "\u00F6"; // fits into 8 bits
